...
#
# 优点:
#   - 保留 SFT 的效果，同时只训练新的 DPO adapter
#   - 使用 precompute_ref_log_probs=True，显存占用减半
#   - 预计算时禁用 DPO adapter，使用 SFT 状态作为 reference
#
# Requirements:
...
OUTPUT_DIR = os.environ.get("OUTPUT_DIR", "qwen_lora_dpo_0227_1700")
...
def main():
    ...
    # --------
    print("🔹 Trainable parameters (只训练 DPO adapter):")
